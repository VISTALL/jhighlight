...
public final class LexScan implements sym, java_cup.runtime.Scanner
{
	 ...
	 */
	private static final int ZZ_LEXSTATE[] = {0, 0, 1, 1, 2, 2, 3, 4, 5, 5, 6, 6, 7, 7, 8, 8, 9, 9, 10, 10, 11, 11, 12, 12, 13, 13, 14, 14};
	...
	private static final String ZZ_ROWMAP_PACKED_0 = "\0\0\0\111\0\222\0\333\0\u0124\0\u016d\0\u01b6\0\u01ff" +
	...
	private static final String ZZ_TRANS_PACKED_0 = "\11\20\2\21\1\22\13\20\1\21\5\20\1\23\53\20" +
	...
	private static final class ZzFlexStreamInfo
	{
		 ...
		 */
		ZzFlexStreamInfo(java.io.Reader zzReader, int zzEndRead, int zzStartRead, int zzCurrentPos, int zzMarkedPos, char[] zzBuffer, boolean zzAtEOF, int yyline, int yycolumn)
		{
	...
	{
		zzStreams.push(new ZzFlexStreamInfo(zzReader, zzEndRead, zzStartRead, zzCurrentPos, zzMarkedPos, zzBuffer, zzAtEOF, yyline, yycolumn));
		zzAtEOF = false;
