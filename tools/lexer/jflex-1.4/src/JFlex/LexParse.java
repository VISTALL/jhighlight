...
public class LexParse extends java_cup.runtime.lr_parser
{
	 ...
	 * Constructor which sets the default scanner.
	 */
	public LexParse(java_cup.runtime.Scanner s, java_cup.runtime.SymbolFactory sf)
	{
		super(s, sf);
	}
	 ...
	 * Production table.
	 */
	protected static final short _production_table[][] = unpackFromStrings(new String[]{"\000\151\000\002\002\004\000\002\005\006\000\002\005" +
	 ...
	 * Parse-action table.
	 */
	protected static final short[][] _action_table = unpackFromStrings(new String[]{"\000\214\000\006\002\uffff\077\004\001\002\000\016\003" +
	 ...
	 */
	protected static final short[][] _reduce_table = unpackFromStrings(new String[]{"\000\214\000\004\005\004\001\001\000\004\002\007\001" +
...
class CUP$LexParse$actions
{
	...
	private RegExp makeRepeat(RegExp r, int n1, int n2, int line, int col)
	{
		...
		if(n1 > 0)
		{
			result = r;
			n1--;
			n2--; // we need one concatenation less than the number of expressions to match
		}
		else
		{
