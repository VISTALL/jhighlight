...
public class XmlHighlighter implements ExplicitStateHighlighter
{
	 ...
	 */
	private static final String ZZ_CMAP_PACKED = "\11\3\1\40\1\34\1\0\1\1\1\2\16\3\4\0\1\1\1\10" +
	...
	private static final String ZZ_ACTION_PACKED_0 = "\1\1\2\2\1\3\1\2\3\0\1\4\2\0\2\5" +
	...
	private static final String ZZ_ROWMAP_PACKED_0 = "\0\0\0\42\0\104\0\146\0\210\0\252\0\314\0\356" +
	...
	private static final String ZZ_TRANS_PACKED_0 = "\1\20\1\21\5\20\1\22\6\20\1\23\1\20\1\24" +
	...
	private static final String ZZ_ATTRIBUTE_PACKED_0 = "\5\1\3\0\1\1\2\0\2\1\1\0\1\1\1\11" +
	...
	public int yylex() throws java.io.IOException
	{
		...
		while(true)
		{
			...
			switch(zzAction < 0 ? zzAction : ZZ_ACTION[zzAction])
			{
				...
				case 3:
				{
					mReturningStateTag = yystate();
					yybegin(IN_RIFE_NAME);
					return RIFE_NAME;
				}
				case 40:
					break;
				...
				{
					mReturningStateTag = yystate();
					yybegin(IN_RIFE_NAME_SINGLEQUOTED);
					return RIFE_NAME;
				}
				case 46:
					break;
				...
				case 23:
				{
					yybegin(IN_PROCESSING_INSTRUCTION);
					return PROCESSING_INSTRUCTION;
				}
				case 50:
					break;
