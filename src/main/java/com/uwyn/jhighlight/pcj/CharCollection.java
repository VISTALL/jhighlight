...
public interface CharCollection
{
	 ...
	 *
	 * @param v the element to add to this collection.
	 * @return <tt>true</tt> if this collection was modified
	 *         as a result of adding <tt>v</tt>; returns
	 *         <tt>false</tt> otherwise.
	 * @throws UnsupportedOperationException if the operation is not supported by this
	 *                                       collection.
	 ...
	 * this collection.
	 *
	 * @param c the collection whose elements to add to this
	 *          collection.
	 * @return <tt>true</tt> if this collection was modified
	 ...
	 *
	 * @param c the collection whose elements to test for
	 *          containment.
	 ...
	 *
	 * @param obj the object with which to compare this collection.
	 ...
	 *
	 * @param v the char value to remove from this collection.
	 * @return <tt>true</tt> if this collection was modified
	 ...
	 * this collection.
	 *
	 * @param c the collection whose elements to remove from this
	 *          collection.
	 * @return <tt>true</tt> if this collection was modified
	 ...
	 * this collection.
	 *
	 * @param c the collection whose elements to retain in this
	 *          collection.
	 * @return <tt>true</tt> if this collection was modified
	 ...
	 * Returns the elements of this collection as an array.
	 *
	 * @param a an array to fill with the elements of this
