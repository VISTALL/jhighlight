...
public interface CharKeyMap
{
	 ...
	 *
	 * @param obj the object with which to compare this map.
	 ...
	 *
	 * @param key   the key of the mapping to add to this map.
	 ...
	 *
	 * @param map the map whose mappings to add to this map.
