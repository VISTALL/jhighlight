...
public class CharKeyOpenHashMap extends AbstractCharKeyMap implements CharKeyMap, Cloneable, Serializable
{
	 ...
	 *
	 * @param map the map whose mappings to put into the new map.
	 ...
	 * @param capacity     the initial capacity of the map.
	 * @param loadFactor   the load factor of the map.
	 * @param growthFactor the relative amount with which to increase the
	 ...
	 * @param capacity    the initial capacity of the map.
	 * @param loadFactor  the load factor of the map.
	 * @param growthChunk the absolute amount with which to increase the
	 *                    the capacity when a capacity increase is needed.
	 * @throws IllegalArgumentException if <tt>capacity</tt> is negative;
	 *                                  if <tt>loadFactor</tt> is not positive;
	 ...
	 * growth factor of 1.0, and a load factor of 75%.
	 *
	 * @param keyhash the hash function to use when hashing keys.
	 * @throws NullPointerException if <tt>keyhash</tt> is <tt>null</tt>.
	 */
